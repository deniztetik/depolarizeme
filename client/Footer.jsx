    ...
    return (
      <div className="footer-container">
        ...
        <div className={this.state.hidden ? "hidden" : ""}>
          ...
          <p>Users are given an option to save the chat's log and share the link. Understand that=C2=A0<strong>strangers can potentially tell other people anything you tell them,=C2=A0</strong>whether by sharing the log, or just by repeating what you said. Be careful what information you reveal to them.</p>
          ...
          <p>In an Omegle text chat, only the following information is made available to other chat users:</p>
          <ul>
          ...
          <p>Depme uses Google Analytics to track non-personally-identifying statistical information about site usage. Google provides a=C2=A0<a href="http://tools.google.com/dlpage/gaoptout?hl=en">browser add-on to opt out of Google Analytics</a>.</p>
          ...
          <ul>
            <li>Omegle provides an option for publishing a chat log to your Facebook account.</li>
          </ul>
          <p>The Facebook API allows Depme to access other information about you, such as your name and other personal details. However, Depme does=C2=A0<strong>not</strong>=C2=A0share, save, or make any use of this information.</p>
          <p>Depme does not share personal information about you with Facebook, except in order to perform actions you explicitly initiate. Use of Facebook is subject to=C2=A0<a href="https://www.facebook.com/about/privacy/">Facebook's privacy policy</a>.</p>
        </div>
      </div>
    )
  }
